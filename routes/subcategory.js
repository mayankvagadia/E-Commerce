...
var CategoryModel = require('../models/category_table');
      ...
      if (err) {
          ...
          CategoryModel.find(function(err,db_category_array){
            if(err){
              ...
              res.render('subcategory/edit-subcategory', { subcategory_array: db_subcategory_array, category_array: db_category_array });
            }
          }).lean();
      }
  }).lean();
